...
Use unit testing to ensure that individual service and controllers do what you expect them to do. You'll be testing
...
This is where you mock your controller dependencies. In this case, we're going to add to inject some ```teams```.
